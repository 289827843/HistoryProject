...
public class CommentController implements ICommentController {
    ...
    public   @ApiResponseObject Result listComment(@ApiBodyObject @RequestBody @Valid ListCommentParam param) {
        ...
        List<ListCommentResult> listCommentResults=cmsCommentService.findComments(param.getArticle_id(),param.getIs_display(),param.getIs_del(),columnName);
        if(listCommentResults!=null){
            return ResultGenerator.genSuccessResult(listCommentResults);
        }else {
